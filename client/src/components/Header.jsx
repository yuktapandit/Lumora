...
const Header = () => {
  ...
  return (
    ...
    viewport={{once: true}}
    >
        <motion.div className="text-stone-500
        inline-flex text-center gap-2 
        bg-white px-6 py-1 rounded-full border
        border-neutral-500"
        ...
        >
            Unleash your reativity with AI. 
        ...
        bg-black w-auto mt-8 px-12 py-2.5 flex 
